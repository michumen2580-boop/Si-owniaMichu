            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
              <div>
                ...
                <div style={{fontSize:13,color:"var(--muted)",marginTop:4}}>
                  {onTrack?"zostało z puli tygodniowej":"przekroczono pulę"}
                </div>
                {daysLeft>0&&onTrack&&<div style={{fontSize:11,color:"var(--muted2)",marginTop:2}}>
                  ≈ <strong style={{color:"#22c55e"}}>{kcalPerDay} kcal/dzień</strong> na {daysLeft} {daysLeft===1?"dzień pozostały":"dni pozostałe"}
                </div>}
              </div>
              <div style={{textAlign:"right"}}>
                <div style={{fontFamily:"'Bebas Neue'",fontSize:22,color:"var(--muted)"}}>
                  {totalEaten.toLocaleString()}
                </div>
                <div style={{fontSize:10,color:"var(--muted)"}}>zjedzone</div>
                <div style={{fontFamily:"'Bebas Neue'",fontSize:16,color:realDeficit>=0?"#22c55e":"#ef4444",marginTop:4}}>
