      ...
      {(()=>{
        ...
        return (
          <div className="card" style={{marginBottom:12}}>
            ...
            {/* GŁÓWNA LICZBA - ile mogę jeszcze zjeść do końca tygodnia */}
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
              <div>
                ...
                <div style={{fontSize:13,color:"var(--muted)",marginTop:4}}>
                  {onTrack?"możesz jeszcze zjeść w tym tygodniu":"przekroczono pulę tygodniową"}
                </div>
                <div style={{fontSize:11,color:"var(--muted2)",marginTop:4}}>
                  zjedzone: <strong style={{color:"var(--text)"}}>{totalEaten.toLocaleString()}</strong>
                  {" "}z puli{" "}
                  <strong style={{color:"var(--text)"}}>{totalTarget.toLocaleString()} kcal</strong>
                </div>
                {daysLeft>0&&onTrack&&<div style={{fontSize:11,color:"var(--muted2)",marginTop:2}}>
                  ≈ <strong style={{color:"#22c55e"}}>{kcalPerDay} kcal/dzień</strong> na {daysLeft} {daysLeft===1?"dzień":"dni"}
                </div>}
              </div>
              <div style={{textAlign:"right"}}>
                <div style={{fontFamily:"'Bebas Neue'",fontSize:20,color:realDeficit>=0?"#22c55e":"#ef4444"}}>
            ...
            {/* PASEK - ile zużyto z puli */}
            <div style={{background:"var(--border)",borderRadius:8,height:12,marginBottom:6,overflow:"hidden"}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",fontSize:11,color:"var(--muted)",marginBottom:10}}>
              <span>0</span>
              <span style={{color:pct>100?"#ef4444":"var(--muted2)",fontWeight:600}}>{pct}% puli</span>
            ...
            <div style={{padding:"8px 12px",background:"var(--card2)",borderRadius:10,fontSize:12,color:"var(--muted2)"}}>
              💡 {goalKcal}/dzień × 7 = {totalTarget.toLocaleString()} kcal · deficyt vs TDEE:{" "}
              <strong style={{color:"#22c55e"}}>-{((tdee-goalKcal)*7/1000).toFixed(2)} kg/tydz.</strong>
            </div>
          </div>
        );
      })()}
