    ...
    <div className="animate-up">
      ...
      <div className="card">
        {imgPreview ? (
          ...
          <label style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10,padding:"24px 0",cursor:"pointer"}}>
            <span style={{fontSize:48}}>📸</span>
            <span style={{fontFamily:"'Bebas Neue'",fontSize:18,letterSpacing:1,color:"var(--muted2)"}}>DODAJ ZDJĘCIE POSIŁKU</span>
            <span style={{fontSize:12,color:"var(--muted)"}}>AI oszacuje kalorie i makroskładniki</span>
      ...
      {todayMeals.length > 0 && (
        <>
          <div className="section-label">Dzisiaj</div>
          {todayMeals.map(m => (
